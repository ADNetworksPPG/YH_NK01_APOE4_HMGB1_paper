...
counts <- read.csv(paste0(indir,"microglia_without_gender_effect/counts_per_sample_per_microglia_subcluster.csv"), header = T)
pheno <- counts %>%
...
write.csv(t(ClusterRes), file = paste0(outdir,"log_odds_ratio_new_method_per_unit_per_histopathology_per_cluster_microglia_no_gender_effect.csv"))
...
histo_all<-read.csv(paste0(outdir,"log_odds_ratio_new_method_per_unit_per_histopathology_per_cluster_microglia_no_gender_effect.csv"))
...
pdf(paste0(plotdir,"microglia_no_gender_effect_subclusters_pathology_heatmap.pdf"), height=6, width=20)
