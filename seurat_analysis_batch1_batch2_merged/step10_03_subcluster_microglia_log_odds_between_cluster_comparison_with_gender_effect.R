...
outdir <- paste0(basedir, 
                 "10_subclusters_log_odds_calculation/microglia_with_gender_effect/")
...
writeLines(capture.output(sessionInfo()), 
           "../sessionInfo_step10_03_subcluster_microglia_log_odds_between_cluster_comparison_with_gender_effect.txt")
