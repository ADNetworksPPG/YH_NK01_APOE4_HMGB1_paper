...
counts <- read.csv(paste0(indir,"counts_per_sample_per_cluster.csv"), header = T)
pheno <- counts %>%
...
colnames(ClusterRes)[c(1:16, 25:32)] <- c("logOddsRatio_for_unit_Hippocampus_Vol_mm3",
                                         ...
                                         "logOddsRatio_for_unit_prop_CD68_Coverage_Area",
                                          ...
                                          "logOddsRatio_for_unit_HMGB1_Intensity_Cytoplasm",
                                          ...
                                          "StdErr_for_unit_HMGB1_Intensity_Cytoplasm",
                                          ...
                                          "pvalue_for_unit_HMGB1_Intensity_Cytoplasm")
...
p.adjust_all <- p.adjust(c(ClusterRes$`pvalue_for_unit_Hippocampus_Vol_mm3`, 
                           ...
                           ClusterRes$`pvalue_for_unit_HMGB1_Intensity_Cytoplasm`), method = "BH")
...
ClusterRes[,"p.pvalue_for_unit_HMGB1_Intensity_Cytoplasm"] = p.adjust_all[(nrow(ClusterRes)*7 + 1):length(p.adjust_all)]
...
ClusterRes$logOddsRatio_for_unit_HMGB1_Intensity_Cytoplasm <- ClusterRes$logOddsRatio_for_unit_HMGB1_Intensity_Cytoplasm*100000
write.csv(t(ClusterRes), file = paste0(outdir,"log_odds_ratio_new_method_per_unit_per_histopathology_per_cluster.csv"))
...
histo_all<-read.csv(paste0(outdir,"log_odds_ratio_new_method_per_unit_per_histopathology_per_cluster.csv"))
...
pdf(paste0(plotdir,"All_37_clusters_log_pathology_heatmap.pdf"), height=6, width=20)
